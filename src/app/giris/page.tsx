      ...
      <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
        ...
        <div className="bg-card p-6 rounded-lg shadow-md border border-border">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="/auth/reset-password" className="text-sm font-medium text-secondary-foreground dark:text-primary hover:underline">
                  Şifremi Unuttum
                </Link>
              </div>
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <a href="/auth/register" className="text-secondary-foreground dark:text-primary hover:underline">
              Hesap Oluşturun
            </a>
          </div>
        </div>
